export const resources = {
  en: {
    translation: {
      ...
      topJackpotGames: "Top jackpot games",
    ...
    translation: {
      ...
      bannersList: {
        1: {
          ...
          titleh1: "Կազինո",
          desc: "Հաստատակամորեն հաղորդակցեք մտքի ընդլայնված զանգվածին, այլ ոչ թե մագնիսական կիրառությունների տարբեր տեխնոլոգիաներին, անխափան վիրտուալ, այնուհետև հարմարավետորեն դրամայնացրեք սիներգետիկ մարդկային կապիտալը",
          btnText: "միացե՛ք մեզ",
        },
        2: {
          titleh3: "Բաններ 2",

...
const infoList = [
    ...
    },
    {
        ...
        imgAlt: 'icon',
        text: 'Address : 30 North West New York',
    },
]
...
const Footer = () => {
    return (
        <footer className="footer-section" style={{backgroundImage: "url(/assets/images/footer/bg.jpg)"}}>
                                    ...
                                    <div className="fm-item-content">
                                        {blogList.map((val, i) => (
                                            <div className="fm-item-widget lab-item" key={i}>
                                                <div className="lab-inner">
                                                    <div className="lab-thumb">
                                                        <Link to="/blog-single"> <img src={`${val.imgUrl}`} alt={`${val.imgAlt}`} className="rounded-3" /></Link>
                                                    </div>
                                                    <div className="lab-content">
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="footer-bottom-content text-center">
                                <p>&copy;2022 <Link to="/">Casino</Link> - All Rights Reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>

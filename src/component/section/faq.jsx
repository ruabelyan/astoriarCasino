...
const Faq = () => {
  ...
  const title = t("frequentylAskQUestion");
  const desc = t("frequentylAskQUestionSubTitle");
                  ...
                  <div className="accordion-item">
                    <div className="accordion-header" id="accTwo">
                      <button
                        ...
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#collTwo"
                        aria-expanded="true"
                        aria-controls="collTwo"
                      >
                        <div className="accordion-list">
                          <div className="left">
                            <div className="icon"></div>
                  ...
                  <div className="accordion-item">
                    <div className="accordion-header" id="accThree">
                      <button
                        ...
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#collThree"
                        aria-expanded="true"
                        aria-controls="collThree"
                      >
                        <div className="accordion-list">
                          <div className="left">
                            <div className="icon"></div>
                  ...
                  <div className="accordion-item">
                    <div className="accordion-header" id="accFour">
                      <button
                        ...
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#collFour"
                        aria-expanded="true"
                        aria-controls="collFour"
                      >
                        <div className="accordion-list">
                          <div className="left">
                            <div className="icon"></div>
